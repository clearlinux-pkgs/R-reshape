...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/reshape_0.8.10.tar.gz
...
%setup -q -n reshape
pushd ..
cp -a reshape buildavx2
popd
pushd ..
cp -a reshape buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750430686
